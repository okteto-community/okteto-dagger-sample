...
func (r OktetodoDagger) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *OktetodoDagger) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
